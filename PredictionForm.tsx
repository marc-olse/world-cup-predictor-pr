      ...
      {finished ? (
        <div className="grid w-56 max-w-[72vw]">
          <button
            ...
            type="button"
          >
            <span className="flex min-w-0 flex-col items-center justify-center gap-1.5 border-r border-ink/10 pb-1 pt-3 text-center leading-none sm:gap-1 sm:py-0">
            ...
            <span className="flex min-w-0 items-center justify-center px-2 pb-1 pt-3 text-center text-xs font-bold leading-tight text-ink/70 sm:px-1.5 sm:py-0 sm:text-[0.62rem]">
              <span>
                {pointsReason}
            ...
            <span
              className={`flex min-w-0 flex-col items-center justify-center gap-1.5 border-l border-ink/10 pb-1 pt-3 text-center leading-none sm:gap-1 sm:py-0 ${pointsClass}`}
            >
              <span className="text-[0.48rem] font-bold uppercase text-ink/45">
                Pts
              </span>
